...
namespace Tyuiu.OzdoevaLM.Sprint7.V13
{
    public partial class FormChart_OLM : Form
    {
        ...
        private void btnLoadFileChart_OLM_Click_1(object sender, EventArgs e)

        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    dataGridView_chart_OLM.DataSource = null; // dataGridView1 — ваша таблица на форме
                    dataGridView_chart_OLM.DataSource = _countryManager.Countries;
        ...
        private void btnPopulationChart_OLM_Click_1(object sender, EventArgs e)
        {
        ...
        private void btnAreaChart_OLM_Click_1(object sender, EventArgs e)
        {
        ...
        private void panelUpChartt_OLM_Paint(object sender, PaintEventArgs e)
        {

        }

        private void buttonCloseFormChart_OLM_Click(object sender, EventArgs e)
        {
            this.Close();
        }

        private void FormChart_OLM_Load(object sender, EventArgs e)
        {
